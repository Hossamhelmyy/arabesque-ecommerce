			...
			<div className="container pt-12 pb-8">
						...
						<ul className="space-y-2">
							...
							<li>
								<Link
									...
									className="hover:text-primary transition-colors">
									{t("categories.textiles", "Textiles")}
								</Link>
							</li>
							<li>
								<Link
									to="/category/ceramics"
									className="hover:text-primary transition-colors">
									{t("categories.ceramics", "Ceramics")}
								</Link>
							</li>
							<li>
								<Link
							...
							<li>
								<Link
									...
									className="hover:text-primary transition-colors">
									{t("categories.homeDecor", "Home Decor")}
								</Link>
							</li>
						</ul>
					</div>
				...
				<div className="flex flex-col sm:flex-row justify-between items-center">
					...
					<p className="mt-4 sm:mt-0 flex items-center">
						{t("footer.madeWith")}{" "}
						<Heart className="h-4 w-4 mx-1 text-destructive animate-pulse" />{" "}
						{t("footer.forYou")}
					</p>
				</div>
			</div>
