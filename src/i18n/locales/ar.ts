export default {
	...
	admin: {
		...
		topProductsDesc: "المنتجات الأكثر مبيعاً هذا الشهر",
	...
	categories: {
		...
		cushions: "وسائد",
		throws: "أغطية",
		tapestries: "معلقات نسيجية",
		pendantLights: "مصابيح معلقة",
		tableLamps: "مصابيح طاولة",
		floorLamps: "مصابيح أرضية",
		lanterns: "فوانيس",
		areaRugs: "سجاد المساحات",
		runners: "سجاد الممرات",
		kilims: "كليم",
		wallArt: "فن الجدار",
		mirrors: "مرايا",
		candleHolders: "حاملات شموع",
		decorativeBoxes: "صناديق زخرفية",
	},
	favorites: {
		title: "المفضلة",
